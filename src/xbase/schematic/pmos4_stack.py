...
class xbase__pmos4_stack(Module):
    """Module for library xbase cell pmos4_stack.
    ...
    def get_master_basename(self) -> str:
        ...
        if stack > 1:
            ans = f'pmos4_{intent}_stack{stack}_w{w}_l{l}_seg{seg}'
        else:
    ...
    def design(self, w: int, lch: int, seg: int, intent: str, stack: int, export_mid: bool) -> None:
        ...
        self.design_transistor('XP', w, lch, seg, intent, g=gate, m='m', stack=stack)
